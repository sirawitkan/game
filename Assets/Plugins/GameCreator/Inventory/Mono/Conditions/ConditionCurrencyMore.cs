namespace GameCreator.Inventory
{
	...
	[AddComponentMenu("")]
	public class ConditionCurrencyMore : ICondition
	{
		...
		public static new string NAME = "Inventory/More Currency";
		private const string NODE_TITLE = "Player has more than {0} of currency";
